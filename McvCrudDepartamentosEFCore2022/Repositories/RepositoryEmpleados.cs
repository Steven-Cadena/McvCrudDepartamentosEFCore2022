...
namespace McvCrudDepartamentosEFCore2022.Repositories
{
    public class RepositoryEmpleados
    {
        ...
        //CONSULTA PARA MOSTRARLOS DIFERENTES OFICIOS 
        //DEBEMOS DEVOLVER UNA COLECCION DE TIPO String
        public List<string> GetOficios() 
        {
            //IMPORTANTE EL DISCTINCT PARA PODER COGER LOS DISTINTOS VALORES SIN REPETIR
            var consulta = (from datos in this.context.Empleados
        ...
        {
            //NECESITAMOS EXTRAER DEL CONTEXT TODOS LOS EMPLEADOS POR SU OFICIO
            List<Empleado> empleados = this.GetEmpleadosOficio(oficio);
            //TENEMOS QUE RECORRER UNO A UNO CADA EMPLEADO PARA IR MODIFICANDO CADA SALARIO
            //CON EL INCREMENTO
        ...
        public List<Empleado> GetEmpleadosDepartamento(int id) 
        {
            var consulta = from datos in this.context.Empleados
